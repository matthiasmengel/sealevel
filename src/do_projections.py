...
parser.add_option('-n', '--nrealizations',  type="int",  help='get number of realizations')
...
classname = {"gic":"glaciers_and_icecaps","thermexp":"thermal_expansion","gis":"surfacemassbalance_gis","gis_sid":"solid_ice_discharge_gis","gis_smb":"surfacemassbalance_gis","ant_sid":"solid_ice_discharge_ais","ant_smb":"surfacemassbalance_ais"}
...
fname = "../data/projection/projected_slr_"+str(nrealizations)+"samples.pkl"

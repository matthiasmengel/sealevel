...
for scen in magicc_scen:
  ...
  magicc_runs  = np.loadtxt(inputdatadir+'/RcpHistoricallyConstrained/RCP.2500/'+scen+'_histConstrain4Katja_DAT_SURFACE_TEMP.txt')
  ...
  magicc_gmt_scen  = da.DimArray(magicc_runs,dims=["time","runnumber"],axes=[magicc_years,np.arange(magicc_runs.shape[1])])
  # harmonize along 1950-1980 mean, make them equvalent to giss
  magicc_gmt[scen] = magicc_gmt_scen - magicc_gmt_scen[1951:1980,:].mean(axis=0) + ggd.preind_to_1951_1980
